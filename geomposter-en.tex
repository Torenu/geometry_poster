...
\begin{columns}
	...
	{
		\begin{center}
			$F, M$ - midpoints of the bases of trapezoid $ABCD$\\
			$\Rightarrow$ points $E, F, M$ lie on the same line \\
			\input{figures/trapezoid_plain.tex}
		\end{center}
	}
	\block{Pythagorean Theorem}
	{
		$$\Delta ABC \text{ - right triangle } \iff a^2 + b^2 = c^2$$
		\begin{center}
	...
	{
		\begin{center}
			The center of the inscribed circle is the point of intersection of the angle bisectors \\
			\vspace{0.5cm}
	...
	{
		\begin{center}
			The center of the circumscribed circle is the point of intersection of the perpendicular bisectors of the sides \\
			\vspace{0.5cm}
	...
	{
		\begin{center}
			$\Delta ABC$ - right triangle $\iff$ $AC$ - diameter,\\
			AO = OC = OB = R\\
			\vspace{0.5cm}
	...
	{
		\begin{center}
			$ABCD$ - inscribed $\iff \alpha + \beta = 180^\circ$\\
			\vspace{0.5cm}
	...
	{
		\begin{center}
			$ABCD$ - circumscribed $\iff AB + CD = BC + AD$\\
			\vspace{0.5cm}
